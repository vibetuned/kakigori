...
def _render_isolated(args):
    ...
    p = multiprocessing.Process(target=_render_target_func, args=(q, mxl_path, output_dir, img_dir))
    p.start()
...
def main():
    ...
    parser.add_argument("--svg_dir", type=str, default="data/output_svgs", help="Output directory for SVGs")
    parser.add_argument("--img_dir", type=str, default="data/output_imgs", help="Output directory for Images")
