...
class GraphVisualizer(QMainWindow):
    ...
    def load_image(self):
        ...
        for ann_path in ann_paths:
            ...
            is_current_page = ann_path.stem == img_path.stem
        ...
        if graph_path.exists():
            try:
                ...
                # Draw Nodes (only those on the currently displayed page)
                for node_id in node_ids:
                    if node_id in current_page_ids:
                ...
                for i in range(edge_index.shape[1]):
                    ...
                    if u_idx < len(node_ids) and v_idx < len(node_ids):
                        ...
                        if u_id in current_page_ids and v_id in current_page_ids:
                            u_ann = node_map[u_id]
                            v_ann = node_map[v_id]
